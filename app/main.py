...
class FrontendDeveloper(SoftwareEngineer):
    def __init__(self, name: str, skills: list = ["JavaScript", "HTML", "CSS"]) -> None:
        super(SoftwareEngineer, self).__init__(name, skills)
...
class BackendDeveloper(SoftwareEngineer):
    def __init__(self, name, skills = ["Python", "SQL", "Django"]):
        super(SoftwareEngineer).__init__(name, skills)
